        ...
        <v-row>
          <v-col sm="5" col="6">
            <div>
              ...
              required placeholder=" " 
              v-model="information" >
              <label>Tell me more information about Project </label>
            </div>
          </v-col>
          <v-col sm="1"></v-col>
          <v-col sm="5" col="6">
...
export default {
    ...
    methods: {
        ...
        let saved = await App.App.EditProject( Project.Name, Project.Skill, Project.information, Project.averageOfprice)
        console.log(saved);
